...
local StarServer = Star:Server("Chiba Hub",8521503225)



	local Main = StarServer:Channel("Main")
	local Combat = StarServer:Channel("Combat")
	local Stats = StarServer:Channel("Stats")
	local Teleport = StarServer:Channel("Teleport")
	local Dungeon = StarServer:Channel("Dungeon")
	local DevilFruit = StarServer:Channel("Fruit")
	local Shop = StarServer:Channel("Shop")
	local Misc = StarServer:Channel("Misc")
	local Op = StarServer:Channel("Check")


Main:Label("Chiba Hub V 0.0.2a")
...
Main:Toggle("Fast Attack[Normal]",true,function(value)
	_G.FastAttack = value
end)
...
Main:Toggle("Fast Attack[Super Pc]",_G.FastAttack2,function(value)
...
local SelectModeMaterial = Main:Dropdown("SelectMaterial",AllMaterial,function(value)
...
Main:Toggle("Auto Farm DF Mastery",_G.AutoFarmFruitMastery,function(value)
...
Main:Toggle("Auto Law Boss",_G.AutoBossLaw,function(value)
    _G.AutoBossLaw = value
    StopTween(_G.AutoBossLaw)
end)

Main:Toggle("Auto Buy Chip",_G.AutoBuyBossLawChip,function(value)
...
Combat:Label("Abilities")

Combat:Toggle("Infinite Energy",false,function(value)
    InfiniteEnergy = value
    originalstam = LocalPlayer.Character.Energy.Value
end)

Combat:Toggle("Auto Active Race",_G.AutoAgility,function(value)
...
Combat:Toggle("Infinite Ability",false,function(value)
    InfAbility = value
    if value == false then
        game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
    end
...
Combat:Toggle("Infinite Obversation Range",getgenv().InfiniteObRange,function(value)
...
Combat:Toggle("Walk on Water",_G.WalkWater,function(value)
    _G.WalkWater = value
end)
...
Combat:Toggle("Fly",false,function(value)
    Fly = value
end)
...
Combat:Toggle("NoClip",_G.NOCLIP,function(value)
    _G.NOCLIP = value
end)
...
Op:Button("Remove Kaitun Cap",function()
		game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").localPlayer)
end)
...
local GodHuman = Op:Label("❌ : GodHuman")
